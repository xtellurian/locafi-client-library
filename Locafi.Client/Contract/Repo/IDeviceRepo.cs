...
namespace Locafi.Client.Contract.Repo
{
    ...
    {
        Task<PageResult<PeripheralDeviceSummaryDto>> QueryDevices(IRestQuery<PeripheralDeviceSummaryDto> query);
        Task<PageResult<PeripheralDeviceSummaryDto>> QueryDevices(string oDataQueryOptions = null);
        ...
        Task<PageResult<RfidReaderSummaryDto>> QueryReaders(IRestQuery<RfidReaderSummaryDto> query);
        Task<PageResult<RfidReaderSummaryDto>> QueryReaders(string oDataQueryOptions = null);
